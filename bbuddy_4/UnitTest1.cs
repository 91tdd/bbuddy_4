...
namespace bbuddy_4
{
    ...
    public class BbuddyTests
    {
        ...
        [TestMethod]
        public void multiple_effective_days_of_one_budget_month()
        {
            GivenBudgets(new Budget { YearMonth = "201804", Amount = 30 });
            TotalBudgetShouldBe(3, new DateTime(2018, 4, 1), new DateTime(2018, 4, 3));
        }

        [TestMethod]
        public void effective_amount()
        {
            GivenBudgets(new Budget { YearMonth = "201804", Amount = 300 });
            TotalBudgetShouldBe(30, new DateTime(2018, 4, 1), new DateTime(2018, 4, 3));
        }
        ...
        public void multiple_budgets()
        {
            ...
            TotalBudgetShouldBe(12, new DateTime(2018, 4, 30), new DateTime(2018, 5, 2));
        }
